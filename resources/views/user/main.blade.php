...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center justify-content-between">
            <h1 class="logo"><a href="index.html"><img src="/assets/img/logo.png" height="100%" alt="">
                    IKM Kota Kupang</a></h1>
    ...
    <footer id="footer">
        <div class="footer-top">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 mx-auto col-md-6 footer-contact">
                        <h3>IKM</h3>
                        <h6>Indeks Kepuasan Masyarakat</h6>
                        <p>
                            Powered By<br />
                            <img src="/assets/img/diskominfo.png" style="max-height: 50px" alt="">
                        </p>
                    </div>
                    <div class="col-lg-3 mx-auto col-md-6 footer-links">
                        ...
                        <ul>
                            <li>
                                <i class="bx bx-chevron-right"></i> <a href="#">kupangkota.go.id</a>
                            </li>
                            <li>
                                <i class="bx bx-chevron-right"></i>
                                <a href="#">kabashoax.kupangkota.go.id</a>
                            </li>
                            <li>
                                <i class="bx bx-chevron-right"></i>
                                <a href="#">ppid.kupangkota.go.id</a>
                            <li>
                        </ul>
                    </div>
                </div>
